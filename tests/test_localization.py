...
from ui_zero.localization import (
    get_text, get_language, set_language, is_chinese, is_english,
    LocalizationManager, nget_text
)
...
class TestLocalization(unittest.TestCase):
    ...
    def test_chinese_translations(self):
        ...
        self.assertEqual(get_text('cli_description'), 'UI-Zero: AI驱动的UI自动化测试工具')
    ...
    def test_english_translations(self):
        ...
        self.assertEqual(get_text('cli_description'), 'UI-Zero: AI-powered UI automation testing')
...
class TestLocalizationIntegration(unittest.TestCase):
    ...
    def test_mo_files_exist(self):
        ...
        # 检查文件大小（应该不为空）
        self.assertGreater(zh_mo.stat().st_size, 0, "Chinese .mo file should not be empty")
        self.assertGreater(en_mo.stat().st_size, 0, "English .mo file should not be empty")
